...
from .forms import RegisterForm, RegisterFormAddOns, LoginForm, CreateRequestForm, CreateEventForm, UpdateProfileForm, \
    ...
    CreateOrUpdateHardDriveSizeChoiceForm, CreateOrUpdateHardDriveStatusChoiceForm
...
def update_request(request, id):
    ...
    if request.method == 'POST':
        ...
        if update_request_form.is_valid() and update_event_form.is_valid():
...
def delete_request(request, id):
    ...
    if request.method == 'POST':
        ...
        return redirect('r_requests')
    context = {'this_request': this_request}
